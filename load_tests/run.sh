...
sleep 5
siege -b -c 500 -r 10 -f urls_usual.txt -v -R .siegerc -m usual
sleep 5

vagrant reload
vagrant ssh -c 'sudo start node-server'
sleep 5
siege -b -c 500 -r 10 -f urls_stricted.txt -v -R .siegerc -m strict
sleep 5

vagrant reload
vagrant ssh -c 'sudo start node-server'
sleep 5
siege -b -c 500 -r 10 -f urls_stricted_ttl.txt -v -R .siegerc -m strict_ttl
